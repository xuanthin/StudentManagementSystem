...
internal class Program
{
    ...
    private static readonly string connectionString = "Data Source=localhost,1433;Initial Catalog=StudentManagementSystem;Integrated Security=True;Encrypt=False";
